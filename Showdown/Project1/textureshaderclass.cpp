...
int TextureShaderClass::GetNumOfObject()
{
	return numOfObject;
}

void TextureShaderClass::SetNumOfObject(int num)
{
	numOfObject = num;
}

int TextureShaderClass::GetNumOfPolygon()
{
	return numOfPolygon;
}

void TextureShaderClass::SetNumOfPolygon(int num)
{
	numOfPolygon = num;
}
