...
PixelInputType LightVertexShader(VertexInputType input)
{
	...
	double angle = atan2(input.instancePosition.x - cameraPosition.x, input.instancePosition.z - cameraPosition.z) * (180.0 / XM_PI);
	...
	//translateMatrix = XMMatrixTranslation(input.instancePosition.x, input.instancePosition.y, input.instancePosition.z);
    ...
    composition = mul(rotationAroundX, composition);
