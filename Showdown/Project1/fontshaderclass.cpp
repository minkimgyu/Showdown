...
int FontShaderClass::GetNumOfObject()
{
	return numOfObject;
}

void FontShaderClass::SetNumOfObject(int num)
{
	numOfObject = num;
}

int FontShaderClass::GetNumOfPolygon()
{
	return numOfPolygon;
}

void FontShaderClass::SetNumOfPolygon(int num)
{
	numOfPolygon = num;
}
